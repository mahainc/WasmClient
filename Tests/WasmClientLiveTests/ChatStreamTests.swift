...
//
// Kept at file scope (not methods) so the `sending` `operation:` closure of
// `withDependencies` does not implicitly capture the non-Sendable XCTestCase
// `self` when calling them. They touch no instance state.
